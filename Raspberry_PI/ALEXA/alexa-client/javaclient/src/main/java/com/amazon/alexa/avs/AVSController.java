...
public class AVSController implements RecordingStateListener, AlertHandler, AlertEventListener,
    ...
    public void startRecording(RecordingRMSListener rmsListener, RequestListener requestListener, String fileInput) {

    		System.out.println("AAVSController: startRecording()");
        ...
        try {
            ...
            InputStream inputStream;
    			System.out.println("Checking audioFileCapture");
            if (audioFileCapture != null) {
            		audioFileCapture.SetFileMode(fileInput);
                inputStream = audioFileCapture.getAudioInputStream(this, rmsListener);
            } else {
                inputStream = getMicrophoneInputStream(this, rmsListener, fileInput);
            }
    ...
    private InputStream getMicrophoneInputStream(AVSController controller,
            RecordingRMSListener rmsListener, String fileInput) throws LineUnavailableException, IOException {
        ...
        for (; numberRetries > 0; numberRetries--) {
            try {
            		microphone.SetFileMode(fileInput);
    ...
    public void onAlexaSpeechStarted() {
	    ExternalStatusController.SetStatus("TALKING");
    ...
    public void setAudioFileCapture(AudioCapture audioFileCapture, boolean test) {
