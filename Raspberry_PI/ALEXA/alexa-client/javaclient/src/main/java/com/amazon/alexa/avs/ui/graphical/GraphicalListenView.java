...
public class GraphicalListenView extends JPanel implements ListenUIHandler {
    ...
    private static final String NOT_LISTENING_LABEL = "External Trigger via: 127.0.0.1/server.php";
    ...
    public void onProcessingFinished() {
	    System.out.println("onProcessingFinished");
